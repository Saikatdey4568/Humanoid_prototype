...
/* Initial position */
void bipedX_v1::initial_position() {
...
void bipedX_v1::move_servo(int time, int  servo_target[]) {
...
void bipedX_v1::say_hi(int count, int speed) {
...
void bipedX_v1::hands_up(int count, int speed) {
...
void bipedX_v1::forward(int steps, int speed) {
  //  if (speed < 500) {
  //    speed = 500;
  //  }
  int degree_array1[20] = {90, 150, 150, 30, 90, 90, 90, 30, 30, 150, 90, 90, 30, 30, 30, 150, 150, 150, 90, 90};
...
void bipedX_v1::turn_right(int steps, int speed) {
  //  if (speed < 500) {
  //    speed = 500;
  //  }
...
void bipedX_v1::turn_left(int steps, int speed) {
  //  if (speed < 500) {
  //    speed = 500;
  //  }
  int pwm_array1[20] = {90, 150, 150, 30, 90, 90, 90, 30, 30, 150, 90, 90, 30, 30, 30, 150, 150, 150, 90, 90};
...
void bipedX_v1::move_right(int steps, int speed) {
  int pwm_array1[20] = {90, 150, 150, 30, 90, 90, 90, 30, 30, 150, 90, 90, 30, 30, 30, 150, 150, 150, 90, 90};
  move_servo(speed, pwm_array1);
  for (int i = 1; i <= steps; i++) {
...
void bipedX_v1::move_left(int steps, int speed) {
  int pwm_array1[20] = {90, 150, 150, 30, 90, 90, 90, 30, 30, 150, 90, 90, 30, 30, 30, 150, 150, 150, 90, 90};
  move_servo(speed, pwm_array1);
  for (int i = 1; i <= steps; i++) {
...
void bipedX_v1::ball_kick_right(int count, int speed) {
  int pwm_array1[20] = {90, 150, 150, 30, 90, 90, 90, 30, 30, 150, 90, 90, 30, 30, 30, 150, 150, 150, 90, 90};
  move_servo(speed, pwm_array1);
  for (int i = 1; i <= count; i++) {
...
void bipedX_v1::ball_kick_left(int count, int speed) {
  int pwm_array1[20] = {90, 150, 150, 30, 90, 90, 90, 30, 30, 150, 90, 90, 30, 30, 30, 150, 150, 150, 90, 90};
  move_servo(speed, pwm_array1);
  for (int i = 1; i <= count; i++) {
...
void bipedX_v1::max_sit(int count, int speed) {
  for (int i = 1; i <= count; i++) {
...
void bipedX_v1::bow(int count, int speed) {
  for (int i = 1; i <= count; i++) {
...
void bipedX_v1::right_bow(int count, int speed) {
  for (int i = 1; i <= count; i++) {
...
void bipedX_v1::left_bow(int count, int speed) {
  for (int i = 1; i <= count; i++) {
...
void bipedX_v1::ape_move(int count, int speed) {
...
void bipedX_v1::push_up(int count, int speed) {
  int degree_array1[20] = {90, 70, 60, 30, 90, 90, 90, 110, 120, 150, 90, 90, 30, 60, 30, 150, 120, 150, 90, 90};
...
void bipedX_v1::clap(int count, int speed) {
...
void bipedX_v1::right_leg_up(int count, int speed) {
...
void bipedX_v1::left_leg_up(int count, int speed) {
...
void bipedX_v1::hip_pose(int count, int speed) {
  for (int i = 1; i <= count; i++) {
...
void bipedX_v1::right_leg_balance(int count, int speed) {
  for (int i = 1; i <= count; i++) {
    int degree_array1[20] = {70, 150, 150, 30, 90, 90, 70, 30, 30, 150, 70, 90, 30, 90, 30, 150, 90, 150, 90, 90};
...
void bipedX_v1::left_leg_balance(int count, int speed) {
  for (int i = 1; i <= count; i++) {
...
void bipedX_v1::flying_action(int count, int speed) {
...
void bipedX_v1::hand_sit_zigzak(int count, int speed) {
...
void bipedX_v1::side_shake(int count, int speed) {
...
void bipedX_v1::hip_shake(int count, int speed) {
...
void bipedX_v1::bend_up(int count, int speed) {
